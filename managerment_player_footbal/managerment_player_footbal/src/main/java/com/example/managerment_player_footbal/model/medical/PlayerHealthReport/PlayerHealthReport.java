...
public class PlayerHealthReport {
    ...
    @DecimalMax(value="300.0",message="Vui lòng nhập đúng cân nặng!")
    private float weight;

    @DecimalMin(value="30.0",message="Vui lòng nhập đúng chiều cao!")
    @DecimalMax(value="300.0",message="Vui lòng nhập đúng chiều cao!")
    private float height;

    @Min(value=30,message="Vui lòng nhập đúng Cholesterol!")
    @Max(value=300,message="Vui lòng nhập đúng Cholesterol!")
    private int cholesterol;

    @Min(value=30,message="Vui lòng nhập đúng nhịp tim!")
    @Max(value=300,message="Vui lòng nhập đúng nhịp tim!")
